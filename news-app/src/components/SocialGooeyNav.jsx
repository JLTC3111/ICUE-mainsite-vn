...
export default function SocialGooeyNav({ reduceMotion = false }) {
  const items = useMemo(() => [
    {
      ...
      content: (
        <>
          ...
          <span className="news-social-gooey__label">YouTube</span>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <span className="news-social-gooey__label">Facebook</span>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <span className="news-social-gooey__label">Zalo</span>
        </>
      ),
    },
  ], [])
  ...
  return (
    <GooeyNav
      ...
      particleCount={reduceMotion ? 0 : 12}
      colors={[1, 2, 3, 4]}
    />
  )
}
