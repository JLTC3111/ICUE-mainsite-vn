      ...
      content: (
        <SocialIcon brand="zalo">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
              className="news-social-gooey__zalo-bubble"
              fill="currentColor"
              d="M12 3C6.9 3 2.8 6.5 2.8 10.8c0 2.4 1.3 4.6 3.3 6-.2.9-.8 2.1-1.5 2.9-.3.3 0 .7.4.6 1.7-.4 3-1 3.9-1.6 1 .3 2 .4 3.1.4 5.1 0 9.2-3.5 9.2-7.8S17.1 3 12 3z"
            />
            <path
              className="news-social-gooey__zalo-mark"
              d="M8.7 8.9h6.6v1.3l-4 4.6h4.1v1.4H8.5v-1.3l4-4.6H8.7z"
            />
          </svg>
        </SocialIcon>
      ),
