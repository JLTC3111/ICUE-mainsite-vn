...
// The drawer links out to the main icue.vn site (hash-routed), mirroring the
    ...
    <>
      ...
      <aside className={`nav-drawer ${open ? 'is-open' : ''}`} aria-hidden={!open}>
        <nav className="nav-drawer__links" aria-label="Site">
          <a href={link('Home')} onClick={close}>
          ...
          <a href={link('orgStructure')} onClick={close}>
          ...
          <a href={link('ourWork')} onClick={close}>
          ...
          <a href={link('pastProjects')} onClick={close}>
          ...
          <a href={link('News')} onClick={close}>
          ...
          <a href={link('aboutUs')} onClick={close}>
            <Icon>
