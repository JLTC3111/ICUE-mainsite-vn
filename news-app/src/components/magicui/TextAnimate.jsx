  ...
  return (
    <AnimatePresence mode="popLayout">
      <MotionComponent
        ...
        exit="exit"
        className={joinClasses('text-animate', className)}
        viewport={{ once, amount: 0.35 }}
        aria-label={accessible ? children : undefined}
        {...props}
      >
        {accessible ? <span className="text-animate__sr-only">{children}</span> : null}
        {segments.map((segment, index) => (
          <motion.span
            ...
            className={joinClasses(
              by === 'line' ? 'text-animate__line' : 'text-animate__segment',
              segmentClassName,
            )}
