...
window.initHomeTextSlider = () => {
  ...
  const messages = [
    "⏳ 10+ năm quản lý đô thị. Với hơn 10 năm kinh nghiệm, nhóm 11 chuyên gia chúng tôi chuyên về quy hoạch đô thị, xây dựng và biến đổi khí hậu. Chúng tôi đã thiết kế những thành phố thông minh, trong một thế giới đang phát triển nhanh chóng — cân bằng giữa chức năng, khả năng phục hồi và nhu cầu của cộng đồng.",
    "🤝 Được xây dựng trên sự thống nhất, thúc đẩy bởi giá trị chung. Chúng tôi tin vào việc đền đáp, thực hành sự thống nhất, làm việc chăm chỉ và không ngừng phấn đấu để tự hoàn thiện. Những giá trị cốt lõi này định hình cách tiếp cận của chúng tôi và truyền cảm hứng cho các quan hệ đối tác với các chuyên gia địa phương, cơ quan chính phủ và chuyên gia pháp lý.",
    "💡 Thành phố thông minh, Giải pháp thông minh hơn. Từ tích hợp thành phố thông minh đến các chiến lược thích ứng với khí hậu, chúng tôi đã sử dụng công nghệ và thông tin chi tiết dựa trên dữ liệu để nâng cao hiệu quả, khả năng kết nối và tính bền vững — xây dựng các thành phố sẵn sàng cho tương lai.",
    "🏆 Thành tựu lớn nhất - Lãnh đạo sáng kiến ​​quy hoạch toàn thành phố Đà Nẵng cho cả thành phố loại 1 và loại 2 — một dự án chuyển đổi tiếp tục tác động đến cuộc sống hàng ngày của hàng nghìn con người. Nó phản ánh sự tận tâm của chúng tôi đối với chiến lược toàn cảnh và kết quả thực tế.",
    "🌱 Định hình thành phố, cải thiện cuộc sống. Mỗi giải pháp chúng tôi cung cấp đều bắt nguồn từ một sứ mệnh: tạo ra 1 đô thị tương lai tốt đẹp hơn. Từ gốc rễ, chúng tôi giúp định hình 1 cách bao trùm, bền vững và lấy con người làm trung tâm.",
