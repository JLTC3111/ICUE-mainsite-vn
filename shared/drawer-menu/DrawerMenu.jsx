    ...
    items: [
      {
        ...
        label: t('drawer.experts'),
        isCurrent: currentPage === 'experts',
        onClick: close,
        icon: () => (
      ...
      },
      {
        ...
        label: t('drawer.coreTeam'),
        isCurrent: currentPage === 'core-team',
        onClick: close,
        icon: () => (
          <Icon><path strokeLinecap="round" strokeLinejoin="round" d="m16.49 12 3.75 3.75m0 0-3.75 3.75m3.75-3.75H3.74V4.499" /></Icon>
        ),
