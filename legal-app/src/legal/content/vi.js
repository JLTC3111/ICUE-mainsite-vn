/**
 * Vietnamese — the source text for the legal documents.
 *
 * This is the authoritative wording: `terms` itself states that the Vietnamese
 * version governs and other languages are provided for reference. Translations
 * in the sibling files are kept structurally identical to this one; the block
 * arrays line up positionally with ../structure.js.
 */
export default {
  "privacy": {
    ...
    "summary": "Cách ICUE thu thập, sử dụng, lưu trữ và bảo vệ thông tin cá nhân khi bạn làm việc với chúng tôi hoặc sử dụng website.",
        ...
        "blocks": [
          {
            ...
            "items": [
              [
                "Thông tin cá nhân",
                "Họ tên, email, số điện thoại và địa chỉ."
              ],
              [
                "Thông tin nghề nghiệp",
                "Kinh nghiệm làm việc, học vấn và kỹ năng."
              ],
              [
                "Thông tin kỹ thuật",
                "Địa chỉ IP, loại trình duyệt và thiết bị sử dụng."
              ],
              [
                "Thông tin tương tác",
                "Trang đã xem, thời điểm và cách bạn sử dụng website."
              ],
              [
                "Cookie và dữ liệu tương tự",
                "Dữ liệu cần thiết để vận hành và cải thiện trải nghiệm."
              ]
            ]
          },
          {
            ...
            "rows": [
              [
                "Thông tin liên hệ",
                "Phản hồi yêu cầu, cập nhật dự án",
                "3 năm hoặc đến khi có yêu cầu xóa"
              ],
              [
                "CV và hồ sơ ứng tuyển",
                "Đánh giá và quản lý ứng viên",
                "2 năm sau khi ứng tuyển"
              ],
              [
                "Dữ liệu website",
        ...
        "blocks": [
          {
            ...
            "items": [
              [
                "Đối tác dự án",
                "Khi cần để thực hiện dự án hoặc dịch vụ đã thỏa thuận."
              ],
              [
              ...
              [
                ...
                "Khi hỗ trợ vận hành website hoặc dịch vụ của ICUE."
              ],
              [
                "Thay đổi tổ chức",
                "Trong trường hợp sáp nhập, chuyển giao hoặc mua lại hợp pháp."
              ]
            ]
          },
          {
        ...
        "blocks": [
          {
            "items": [
              [
                "Truy cập",
                "Yêu cầu bản sao dữ liệu cá nhân mà ICUE đang lưu trữ."
              ],
              [
                "Chỉnh sửa",
                "Cập nhật thông tin không chính xác hoặc chưa đầy đủ."
              ],
              [
                "Xóa dữ liệu",
                "Yêu cầu xóa dữ liệu khi điều kiện pháp lý cho phép."
              ],
              [
                "Hạn chế xử lý",
                "Tạm dừng một số hoạt động xử lý trong trường hợp phù hợp."
              ],
              [
                "Di chuyển dữ liệu",
                "Nhận dữ liệu ở định dạng có cấu trúc và có thể đọc được."
              ],
              [
                "Phản đối",
                "Phản đối xử lý dữ liệu, đặc biệt cho tiếp thị trực tiếp."
              ]
            ]
          },
          {
  ...
  "terms": {
    ...
    "summary": "Các điều kiện áp dụng khi truy cập website, sử dụng nội dung và làm việc với các dịch vụ trực tuyến của ICUE.",
        ...
        "blocks": [
          {
            "items": [
              [
                ...
                "Kinh tế, phát triển đô thị, xây dựng và bền vững."
              ],
              [
                "Đào tạo",
                "Khóa học và chương trình nâng cao năng lực."
              ],
              [
                "Thông tin",
                "Báo cáo, nghiên cứu và dữ liệu chuyên ngành."
              ],
              [
                "Sự kiện",
                "Hội thảo, tọa đàm và hoạt động chuyên môn."
              ],
              [
                "Website",
                "Nền tảng thông tin và tương tác trực tuyến."
              ]
            ]
          },
          {
        ...
        "blocks": [
          {
            "items": [
              [
                "Thương lượng",
                "Các bên thiện chí trao đổi trực tiếp."
              ],
              [
                "Hòa giải",
                "Sử dụng tổ chức hòa giải phù hợp nếu cần."
              ],
              [
                "Trọng tài",
                "Đệ trình lên Trung tâm Trọng tài Quốc tế Việt Nam khi có thỏa thuận."
              ],
              [
                "Tòa án",
                "Đưa vụ việc đến tòa án có thẩm quyền tại Hà Nội."
              ]
            ]
          }
        ]
        ...
        "blocks": [
          {
            "items": [
              [
                "Hiệu lực từng phần",
                "Nếu một điều khoản vô hiệu, phần còn lại vẫn có hiệu lực."
              ],
              [
                "Ngôn ngữ",
                "Phiên bản tiếng Việt là bản chính thức; bản dịch chỉ để tham khảo."
              ],
              [
                "Thông báo",
                "Thông báo chính thức được gửi qua email hoặc đăng trên website."
              ],
              [
                "Điều khoản riêng",
                "Hợp đồng cụ thể có thể bổ sung hoặc thay đổi nội dung áp dụng."
              ]
            ]
          }
        ]
  ...
  "gdpr": {
    ...
    "summary": "Tìm hiểu tám quyền dữ liệu cơ bản và cách gửi yêu cầu đến ICUE theo Quy định Bảo vệ Dữ liệu Chung của Liên minh Châu Âu.",
        ...
        "blocks": [
          {
            "items": [
              [
                "Xác định yêu cầu",
                "Chọn quyền bạn muốn thực hiện và dữ liệu liên quan."
              ],
              [
                "Gửi yêu cầu",
                "Email đến info@icue.vn với tiêu đề “[GDPR Request]”."
              ],
              [
                "Xác minh danh tính",
                "ICUE có thể yêu cầu thông tin cần thiết để bảo vệ dữ liệu."
              ],
              [
                "Xử lý",
                "Yêu cầu được đánh giá và xử lý theo thời hạn áp dụng."
              ],
              [
                "Nhận phản hồi",
                "Bạn nhận kết quả và thông tin về bước tiếp theo nếu có."
              ]
            ]
          }
        ]
        ...
        "blocks": [
          {
            "items": [
              [
                "Khiếu nại nội bộ",
                "Liên hệ đầu mối bảo vệ dữ liệu của ICUE."
              ],
              [
                "Cơ quan giám sát",
              ...
              [
                "Khởi kiện",
                "Thực hiện biện pháp tư pháp theo pháp luật áp dụng."
              ]
            ]
          },
          {
  ...
  "cookies": {
    ...
    "summary": "Cookie là gì, những nhóm cookie website có thể sử dụng và cách bạn kiểm soát lựa chọn của mình.",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "_ga",
                "Hiệu suất",
                "Phân biệt người dùng trong Analytics",
                "2 năm"
              ],
              [
                "_gat",
        ...
        "blocks": [
          {
            ...
            "headers": [
              "Nhóm bị tắt",
              "Mức ảnh hưởng",
              "Chức năng có thể mất"
            ],
            "rows": [
              [
                "Cần thiết",
                "Nghiêm trọng",
                "Phiên làm việc và chức năng bảo mật"
              ],
              [
                "Chức năng",
                "Trung bình",
                "Ngôn ngữ, giao diện và tùy chọn"
              ],
              [
                "Hiệu suất",
                "Thấp",
                "Dữ liệu hỗ trợ cải thiện website"
              ],
              [
                "Marketing",
                "Rất thấp",
                "Đo lường chiến dịch và cá nhân hóa quảng cáo"
              ]
            ]
          }
        ]
