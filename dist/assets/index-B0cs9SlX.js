(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();const c=(()=>{const i=new Map;function n(){document.querySelectorAll(".card.image-card").forEach(e=>{i.has(e)||i.set(e,e.getAttribute("data-aos"))})}function a(){console.log("[AOS] Restoring AOS attributes"),i.forEach((e,t)=>{t.setAttribute("data-aos",e||"flip-down"),t.classList.add("aos-init"),t.classList.remove("aos-animate"),t.style.opacity=null,t.style.transform=null,t.style.filter=null}),window.AOS&&window.AOS.refreshHard()}function o(){console.log("[AOS] Clearing AOS attributes"),document.querySelectorAll("[data-aos]").forEach(e=>{i.has(e)||i.set(e,e.getAttribute("data-aos")),e.removeAttribute("data-aos"),e.classList.remove("aos-init","aos-animate"),e.style.opacity=1,e.style.transform="none",e.style.filter="none"})}return window.handleAOSByScreenSize=()=>{const e=window.innerWidth;if(console.log(`[AOS] Window resized to: ${e}px`),typeof window.AOS>"u"){console.warn("[AOS] AOS library not loaded.");return}e<1025?(console.log("[AOS] Small screen – disabling AOS"),o()):(console.log("[AOS] Large screen mode – Enabling AOS"),a(),window.AOS.init({disable:!1,duration:1850,offset:225,once:!1}))},{handleAOSByScreenSize,cacheAOSAttributes:n}})();window.handleAOSByScreenSize=c.handleAOSByScreenSize;function f(i,n){let a=null;return function(...o){clearTimeout(a),a=setTimeout(()=>i.apply(this,o),n)}}window.addEventListener("resize",f(()=>{console.log("[AOS] Resize triggered"),c.handleAOSByScreenSize()},50));window.addEventListener("DOMContentLoaded",()=>{c.cacheAOSAttributes(),console.log("[AOS] DOMContentLoaded"),c.handleAOSByScreenSize()});(function(i){function n(o="body"){try{const e=`
footer {
...
`,t=`
            ...
            <div class="footer-container">
                ...
                <div class="footer-brand">
                        <div class="security-badges">
                            <div class="badge trustwave" data-tooltip="Xác Nhận Bởi Trustwave">
        ...
        `;if(!document.querySelector("#icue-footer-style")){const s=document.createElement("style");s.id="icue-footer-style",s.textContent=e,document.head.appendChild(s)}const r=document.querySelector(o);return r?(r.insertAdjacentHTML("beforeend",t),document.querySelectorAll(".footer-toggle").forEach(s=>{s.addEventListener("click",()=>{s.closest(".footer-section").classList.toggle("open");const d=s.getAttribute("aria-expanded")==="true";s.setAttribute("aria-expanded",!d)})}),console.log("ICUEFooter: Successfully injected footer"),!0):(console.error("ICUEFooter: Target element not found"),!1)}catch(e){return console.error("ICUEFooter: Error injecting footer",e),!1}}function a(){const o=()=>{const e=["#Home","#/aboutUs","#/orgStructure","#/meetOurExperts","#/coreTeam","#/Contact","#/cookies","#/privacy","#/gdpr","#/terms","#/FAQs","#/recruitment","#/donations","#/notableAwards","#/communityActivities","#/pastProjects"],t=window.location.hash.trim();console.log("Current page:",t);const r=t.replace(/\/$/,"").toLowerCase();if(!e.map(l=>l.toLowerCase()).includes(r)){const l=document.querySelector("footer");l&&l.remove();return}document.querySelector("footer")?console.log("Footer already exists."):n()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",o):(console.log("Footer already exists, skipping injection."),o())}i.ICUEFooter={inject:n,autoInject:a,injectInto(o){return typeof o=="string"&&(o=document.querySelector(o)),o?n(o):(console.error("ICUEFooter: Element not found"),!1)},updateLinks(o){const e=document.querySelectorAll(".footer-section");if(o.company&&e[0]){const t=e[0].querySelector(".collapsible");t.innerHTML=o.company.map(r=>`<a href="${r.url}">${r.text}</a>`).join("")}if(o.pages&&e[1]){const t=e[1].querySelector(".collapsible");t.innerHTML=o.pages.map(r=>`<a href="${r.url}">${r.text}</a>`).join("")}}}})(window);
